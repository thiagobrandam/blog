import { NumberSystems } from "./systems";
...
export function convertNumber(system, number) {
  if (!NumberSystems[system]) return "Unsupported number system";

  number = +number;
  if (isNaN(number)) return "Input is not numeric";
